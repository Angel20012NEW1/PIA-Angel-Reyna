...
<ul>
  ...
  <li class="dropdown">
	...
	<?php
		...
		echo "<center>";
		echo "<h1>Actualizar datos de la tabla Proveedores</h1>";
		echo "<table border='3'>
			<tr>
			<th>Clave</th>
			<th>Nombre</th>
		...
		mysqli_close($con);
?>
<h3>Escribe la CLAVE del Proveedor a editar</h3>
<form action="Actualizar2_prov.php" method="POST">
	Clave Proveedor: <input type="text" name="id">
	<br>
	<br>
